                    ...
                    <div className="contact-wrap-padding">
                        <div className="row justify-content-center">
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/doctor.png" width="45px"></img>
                                    </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/hospital.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/ambulance.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/Camping.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/nanotechnology.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/amenities.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/surgery-room.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/technical-support.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/pharmacy.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/coronavirus.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/blood-bank.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-8">
                                <div className="contact-info-box text-center mb-30">
                                    <div className="contact-box-icon">
                                        <img src="img/icon/microscope.png" width="45px"></img>
                                    </div>
                                    <div className="contact-info-content">
