                ...
                <div className="app-main">
                                ...
                                <ul className="vertical-nav-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="Pharmacy_update" className="mm-active">
                                                    <i className="metismenu-icon"></i> Pharmacy |Edit,Delete
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                    ...
                    <div className="app-main__outer">
                        <div className="app-main__inner">
                            ...
                            {/* Add Form Here */}
                            <h1>Pharmacy Details Update Form</h1>
...
<h5 className="card-title">Pharmacy Details</h5>
<p className="card-text">
 Location : Mainstreet, Colombo.
 <br></br>
 Telephone Number : 024 222 5090.
 <br></br>
 Working Days : Weekdays Only.
 <br></br>
 Working Hours : Mrg 8.00 - Nt 10.00
</p>
<p className="card-text">
<small className="text-muted">Last updated 3 mins ago</small>
  ...
  <Button variant="success" type="Update" >Update</Button>
  </div>
</div>
  <div className="card">
...
<h5 className="card-title">Pharmacy Details</h5>
<p className="card-text">
Location : Seastreet, Colombo.
 <br></br>
 Telephone Number : 024 222 0090.
 <br></br>
 Working Days : Weekdays Only.
 <br></br>
 Working Hours : Mrg 8.00 - Nt 8.00
</p>
<p className="card-text">
...
<h5 className="card-title">Pharmacy Details</h5>
<p className="card-text">
Location : Main Market, Colombo3.
 <br></br>
 Telephone Number : 024 222 4567.
 <br></br>
 Working Days : Weekdays, Weekend.
 <br></br>
 Working Hours : Mrg 8.00 - Nt 10.00
</p>
<p className="card-text">
...
<h5 className="card-title">Pharmacy Details</h5>
<p className="card-text">
Location : Manink Place, Colombo.
 <br></br>
 Telephone Number : 024 333 5090.
 <br></br>
 Working Days : Weekdays, Weekend .
 <br></br>
 Working Hours : Mrg 8.00 - Nt 10.00
...
export default Pharmacy_update